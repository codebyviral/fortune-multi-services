  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">What is a Municipal Trade License?</h2>
        <p className="mb-4">
          A <strong>Municipal Trade License</strong> is a <strong>mandatory approval</strong> issued by the <strong>local municipal corporation</strong> that authorizes a business to operate within city limits. It helps regulate commercial establishments and ensures they follow health, safety, and environmental standards.
        </p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">Who Needs a Municipal Trade License?</h2>
        <p className="mb-4">
          Municipal Trade Licenses are <strong>mandatory</strong> for businesses engaged in commercial activities, including:
        </p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">Why is a Municipal Trade License Important?</h2>
        <div className="bg-blue-50 p-4 rounded-lg">
          <ul className="space-y-2">
            <li className="flex items-start">
              <span className="text-green-500 mr-2">✅</span>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">Types of Municipal Trade Licenses</h2>
        <div className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="text-xl font-semibold mb-2">1. General Trade License</h3>
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="text-blue-500 mr-2">🔹</span>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="text-xl font-semibold mb-2">2. Food Trade License</h3>
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="text-blue-500 mr-2">🔹</span>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="text-xl font-semibold mb-2">3. Industrial Trade License</h3>
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="text-blue-500 mr-2">🔹</span>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="text-xl font-semibold mb-2">4. Health Trade License</h3>
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="text-blue-500 mr-2">🔹</span>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="text-xl font-semibold mb-2">5. Liquor Trade License</h3>
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="text-blue-500 mr-2">🔹</span>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">Application Process</h2>
        <div className="space-y-4">
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
            <h3 className="font-semibold">Step 1: Choose Business Premises & Verify Zoning Regulations</h3>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
            <h3 className="font-semibold">Step 2: Register the Business</h3>
            <ul className="mt-2 space-y-1">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
            <h3 className="font-semibold">Step 3: Submit Application to the Municipal Corporation</h3>
            <ul className="mt-2 space-y-1">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
            <h3 className="font-semibold">Step 4: Upload/Submit Required Documents</h3>
            <ul className="mt-2 space-y-1">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
            <h3 className="font-semibold">Step 5: Pay the Trade License Fee</h3>
            <ul className="mt-2 space-y-1">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
            <h3 className="font-semibold">Step 6: Inspection & Approval</h3>
            <ul className="mt-2 space-y-1">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">Documents Required</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-green-50 p-4 rounded-lg">
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="text-green-600 mr-2">✔</span>
                <span><strong>PAN Card</strong> of the Business Owner / Company</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-600 mr-2">✔</span>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">Penalties for Non-Compliance</h2>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-semibold">1. Who issues a Municipal Trade License?</h3>
            <p className="mt-1">
              <span className="text-green-600 mr-2">✔</span>
              The local <strong>Municipal Corporation or Municipality</strong> issues trade licenses.
            </p>
          </div>
          
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-semibold">2. Is a Trade License mandatory for online businesses?</h3>
            <p className="mt-1">
              <span className="text-green-600 mr-2">✔</span>
              If the business has a <strong>physical office, warehouse, or manufacturing unit</strong>, a trade license is required.
            </p>
          </div>
          
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-semibold">3. Can I transfer my Trade License?</h3>
            <p className="mt-1">
              <span className="text-green-600 mr-2">✔</span>
              No, trade licenses are <strong>non-transferable</strong>. A new license is required for new ownership.
            </p>
          </div>
          
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-semibold">4. What happens if my Trade License expires?</h3>
            <p className="mt-1">
              <span className="text-green-600 mr-2">✔</span>
              Businesses must <strong>renew before expiry</strong>. <strong>Late renewal attracts penalties.</strong>
            </p>
          </div>
          
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-semibold">5. Can a residential property be used for business without a Trade License?</h3>
            <p className="mt-1">
              <span className="text-red-600 mr-2">❌</span>
              No, <strong>residential properties cannot be used for commercial activities without proper zoning and approvals.</strong>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-12 border-t pt-6">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4">Conclusion</h2>
        <p className="mb-4">
          A <strong>Municipal Trade License is essential for legally operating a business</strong> and ensures compliance with <strong>health, safety, and environmental regulations</strong>.
        </p>
