...
>
    <div className="relative">
        <motion.button 
            className="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-full py-3 px-6 flex items-center shadow-xl hover:shadow-2xl transition-all font-medium"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
...
>
    <div className="relative">
        <motion.button 
            className="bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white rounded-full py-3 px-6 flex items-center shadow-xl hover:shadow-2xl transition-all font-medium"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
